 ...
 * @since 1.0
 */
public class CreateUserDAO  implements SessionAware{
    ...
    public int insertTemp(String userName, String password, String email,
        ...
        try{
            ...
            ps.setString(9,cardHolder);
            ps.setString(10,securityCode);
            ps.setString(11, nameKana);
            count = ps.executeUpdate();
