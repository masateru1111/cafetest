...
<body>
	...
	<div id="backimg">
		...
		<!-- ログインここまで -->
		<!-- メイン -->
		<s:form action="EditUserAction">
			<div id="backimg">
				<br>
				<s:iterator value="message">
					<s:property value="cardErrorMessage" />
				</s:iterator>
				<s:iterator value="cellNumberConfirmErrorMessage">
					<s:property value="cellNumberConfirmErrorMessage" />
				</s:iterator>
				<h2>情報変更</h2>
				<div class="form">
					<s:iterator value="message">
					...
					<table class="create">
						...
						<tr>
							<td><s:password type="password" id="password"
									name="password" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td><span style="color: red">※</span> メールアドレス(半角)</td>
						</tr>
						<tr>
